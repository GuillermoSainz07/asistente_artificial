...
with st.sidebar:
    st.image('logo.png',caption="Proyecto de servicio social FACES. \n Asistente basado el modelo de lenguaje Gemini, con contexto agregado sobre leyes y codigos utililes para el area \
